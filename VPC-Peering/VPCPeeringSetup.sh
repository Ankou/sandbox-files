...
read -p "Created VPCs:  Press Enter to continue..."
...
read -p "Created Private route tables:  Press Enter to continue..."
...
read -p "Created Internet Gateways:  Press Enter to continue..."
...
read -p "Attached IGWs to VPCs:  Press Enter to continue..."
